...
const GameCatalog = () => {
  ...
  // Mock data fallback
  const mockGames = [
    { id: 'code-breakers-team', title: 'Operation Nightfall (Code Breakers)', description: 'Role-driven collaborative cipher mission. Each player holds critical intel – progress demands true teamwork.', category: 'Problem Solving', difficulty: 'Medium', duration: '20-30 min', playerCount: '4 players', rating: 4.9, tags: ['Problem Solving', 'Collaboration', 'Roles', 'Spy'], icon: KeyRound, color: '#7c3aed', emoji: '🕵️', playable: true },
    { id: 'future-1', title: 'Trust & Transparency Challenge', description: 'Coming soon', category: 'Trust', difficulty: 'Medium', duration: '45-60', playerCount: '4-12', rating: 0, tags: [], icon: Heart, color: '#334155', emoji: '⏳', playable: false },
    { id: 'future-2', title: 'Innovation Storm', description: 'Coming soon', category: 'Creativity', difficulty: 'Medium', duration: '30-45', playerCount: '5-15', rating: 0, tags: [], icon: Brain, color: '#334155', emoji: '⏳', playable: false }
  ]
